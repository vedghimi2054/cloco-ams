...
#
# For the full list.py of settings and their values, see
...
#     SECRET_KEY = 'django-insecure-o*&&0g=i!)vmlkl^r*vcr!_+fflhs*xyx=!z7*ai#avb%vq@0%'
#
...
#     #
#     # REST_FRAMEWORK = {
#     #     'DEFAULT_PAGINATION_CLASS': 'ams.base.pagination.CustomPagination',
#     #     'PAGE_SIZE': 100
#     # }
#
#     INSTALLED_APPS = [
...
#     ]
#
#     DATABASES = DatabaseURLValue(environ="DATABASE_URL")
#
#     REST_FRAMEWORK = {
